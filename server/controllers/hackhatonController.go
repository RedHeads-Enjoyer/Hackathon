...
func (hc *HackathonController) GetByIDEditFull(c *gin.Context) {
	...
	// Проверяем, можно ли редактировать хакатон (до начала регистрации) для демонстрации
	//currentTime := time.Now()
...
func (hc *HackathonController) InviteUser(c *gin.Context) {
...
func (hc *HackathonController) AcceptTeamInvite(c *gin.Context) {
...
func (hc *HackathonController) RejectTeamInvite(c *gin.Context) {
	// Извлечение ID приглашения из URL
	inviteID := c.Param("invite_id")
	if inviteID == "" {
		c.JSON(http.StatusBadRequest, gin.H{"error": "Отсутствует идентификатор приглашения"})
...
func (hc *HackathonController) GetTeamInvitesForMe(c *gin.Context) {
	// Извлечение ID пользователя из claims
	claims := c.MustGet("user_claims").(*types.Claims)
	userID := claims.UserID
...
func (hc *HackathonController) GetTeamMembers(c *gin.Context) {
...
func (hc *HackathonController) InviteMentor(c *gin.Context) {
	// Извлечение ID хакатона из URL
	hackathonID := c.Param("hackathon_id")
	if hackathonID == "" {
		c.JSON(http.StatusBadRequest, gin.H{"error": "Отсутствует идентификатор хакатона"})
...
func (hc *HackathonController) GetMentorInvitations(c *gin.Context) {
	// Извлечение ID хакатона из URL
	hackathonID := c.Param("hackathon_id")
	if hackathonID == "" {
		c.JSON(http.StatusBadRequest, gin.H{"error": "Отсутствует идентификатор хакатона"})
...
func (hc *HackathonController) AcceptMentorInvite(c *gin.Context) {
	// Извлечение ID приглашения из URL
	inviteID := c.Param("invite_id")
	if inviteID == "" {
		c.JSON(http.StatusBadRequest, gin.H{"error": "Отсутствует идентификатор приглашения"})
...
func (hc *HackathonController) RejectMentorInvite(c *gin.Context) {
	// Извлечение ID приглашения из URL
	inviteID := c.Param("invite_id")
	if inviteID == "" {
		c.JSON(http.StatusBadRequest, gin.H{"error": "Отсутствует идентификатор приглашения"})
...
func (hc *HackathonController) GetMyMentorInvites(c *gin.Context) {
